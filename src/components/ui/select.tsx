...
const SelectItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & {isArrow?:boolean}
>(({ className,isArrow=true, children, ...props }, ref) => (
  ...
  >
    {
      isArrow && <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
