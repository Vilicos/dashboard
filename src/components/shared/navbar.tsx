...
function Navbar() {
  return (
    <nav className="fixed left-0 top-0 bottom-0 z-30 bg-card border-r shadow-md backdrop-blur-sm h-full w-[72px] hover:w-52 py-3 flex flex-col gap-y-4 transition-width overflow-hidden group rounded-md">
